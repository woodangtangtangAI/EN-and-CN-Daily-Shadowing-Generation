...
async def main_async():
    ...
    - 형식: 친구끼리의 대화, 뉴스 앵커의 브리핑, 팟캐스트 진행자의 독백, 전문적인 비즈니스 회의, 프레젠테이션, 부부 싸움 등 세상의 모든 형식 중 랜덤 1개
    ...
    - 영어: 미국식 영어 기준. Chunking(끊어 읽기 표시인 '/' 또는 '//') 절대 사용 금지. 어설픈 직역체 배제. 가장 자연스럽고 트렌디한 일상 구어(Colloquial) 활용.
    - 중국어: 중국어 간체자로 번역. 모든 중국어 원문과 중국어 단어에 발음 기호인 병음(Pinyin) 필수 표기. Chunking 절대 사용 금지. 한국식 직역 배제, 네이티브 찐 표현 사용.
